...
class CLSOrgResiPQModel(BaseModel):
    """Base model for image classification."""

    def __init__(self, opt):
        super(CLSOrgResiPQModel, self).__init__(opt)
    ...
    def optimize_parameters(self):
        ...
        self.output = self.net(self.concat_img, self.poc, self.qp)
            ...
            if with_metrics:
                ...
                for name, opt_ in opt_metric.items():
                    ...
                    self.metric_results[name] += getattr(
                        metric_module, metric_type)(self.output, self.gt)#, **opt_)
