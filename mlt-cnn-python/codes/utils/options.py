...
def parse(opt_path, is_train=True):
    ...
    for phase, dataset in opt['datasets'].items():
        ...
        #if dataset.get('dataroot_org') is not None:
        #    dataset['dataroot_org'] = osp.expanduser(dataset['dataroot_org'])
    ...
    if is_train:
        ...
        opt['path']['visualization'] = osp.join(experiments_root,
                                                'visualization')
        opt['path']['tb_logger'] = osp.join(experiments_root, 'tb_logger')  # 210318 added
